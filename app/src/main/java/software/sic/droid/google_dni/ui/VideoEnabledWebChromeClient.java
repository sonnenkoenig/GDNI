...
//TODO: taken from https://github.com/cprcrack/VideoEnabledWebView
//TODO: add license(MIT), add to ProGuard? -keepclassmembers class name.cpr.VideoEnabledWebView$JavascriptInterface { public *; }
            ...
            else
            {
                ...
                if (webView != null && webView.getSettings().getJavaScriptEnabled() && focusedChild instanceof SurfaceView)
                {
                    ...
                    js += "if (_ytrp_html5_video != undefined && _ytrp_html5_video != _ytrp_html5_video_last) {";
                    {
                        ...
                        {
                            js += VideoEnabledWebViewWithLog.INJECTED_JS_OBJECT_ID + ".notifyVideoEnd();"; // Must
                            // match Javascript interface
                            // name and method of VideoEnableWebView
                        }
                        js += "}";
